...
<div class="register-container">
    <h4>Institute Register Form</h4>

    <form action="save">
        <label for="institute_id">ID:</label>
        <input type="number" id="institute_id" name="id" required>

        <label for="institute_name">Name:</label>
        <input type="text" id="institute_name" name="iname" required>

        <label for="institute_city">City:</label>
        <input type="text" id="institute_city" name="icity" required>

        <label for="institute_fees">Fees:</label>
        <input type="number" id="institute_fees" name="ifess" required>
